...
struct task_info task2_4 = {(uint32_t)&lock_task1, USER_THREAD, 1};//KERNEL_THREAD};
struct task_info task2_5 = {(uint32_t)&lock_task2, USER_THREAD, 1};//KERNEL_THREAD};
struct task_info task2_11 = {(uint32_t)&lock_task3, USER_THREAD, 1};//KERNEL_THREAD};
...
struct task_info task2_8 = {(uint32_t)&printf_task1, USER_PROCESS, 100};
struct task_info task2_9 = {(uint32_t)&printf_task2, USER_PROCESS, 20};
struct task_info task2_10 = {(uint32_t)&drawing_task2, USER_PROCESS, 10};
